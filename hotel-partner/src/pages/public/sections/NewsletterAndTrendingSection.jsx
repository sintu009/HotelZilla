    ...
    <section className="relative w-full overflow-hidden bg-[#252525] px-6 pb-20 pt-32 sm:px-12 lg:px-[8%]">
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-16 lg:grid-cols-[1fr_1px_1fr] lg:gap-12">
        ...
        <section className="lg:pr-8">
          ...
          <form className="mt-10 flex max-w-full flex-col gap-3 sm:flex-row sm:items-center" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="submit" className="h-[64px] w-full rounded-xl bg-[#c49c74] px-8 font-display text-lg font-medium tracking-[0.10px] text-[#252525] shadow-[inset_2px_0px_4px_#00000040] hover:bg-[#d0aa84] sm:w-[180px]">Subscribe</button>
          </form>
        ...
        <section className="lg:pl-8">
          ...
          <div className="mt-12 grid grid-cols-2 grid-rows-[152px_152px_171px] gap-x-5 gap-y-4">
            {destinations.map((d) => (
              <button key={d.name} className={`group relative block overflow-hidden rounded-2xl p-0 text-left hover:bg-transparent ${d.className}`}>
