...
export default function RegisterHotel() {
  ...
  const [form, setForm] = useState({
    ...
    star_rating: 3, contact_phone: '', contact_email: '', total_rooms: 0, price_from: 0,
  cover_image: '', images: '',
  })
        ...
        <form onSubmit={handleSubmit}>
          <div className="reg-grid">
            ...
            <div className="form-group">
              ...
              <select className="input" value={form.star_rating} onChange={e => update('star_rating', +e.target.value)}>
          ...
          <div className="form-group">
            ...
            <textarea className="input" rows={3} value={form.description} onChange={e => update('description', e.target.value)} placeholder="Describe your hotel..." />
          </div>
          ...
          <div className="reg-grid">
            <div className="form-group">
              ...
              <input className="input" type="number" value={form.total_rooms} onChange={e => update('total_rooms', +e.target.value)} />
            </div>
            <div className="form-group">
              <label className="label">Starting Price (per night)</label>
              <input className="input" type="number" value={form.price_from} onChange={e => update('price_from', +e.target.value)} />
            </div>
          </div>

          <div className="form-group">
            <label className="label">Cover Image URL</label>
            <input className="input" value={form.cover_image} onChange={e => update('cover_image', e.target.value)} placeholder="https://..." />
          </div>

          <div className="form-group">
            <label className="label">Additional Image URLs (comma-separated)</label>
            <input className="input" value={form.images} onChange={e => update('images', e.target.value)} placeholder="https://..., https://..." />
          </div>
