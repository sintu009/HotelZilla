...
export const OFFERS = [
  { id: 'of1', title: 'Summer Super Saver', description: 'Get up to 50% off on summer bookings', discount_type: 'percentage', discount_value: 50, code: 'SUMMER50', image_url: 'https://images.treebohotels.com/images/Masthead-Jul-Web-Masthead.jpg', start_date: '2026-06-01', end_date: '2026-09-30', is_active: true, created_at: '2026-05-20T10:00:00Z' },
...
export const CMS_BANNERS = [
  { id: 'bn1', title: 'Summer Sale', subtitle: 'Up to 50% off on luxury hotels', image_url: 'https://images.treebohotels.com/images/Masthead-Jul-Web-Masthead.jpg', link_url: '/offers', display_order: 1, is_active: true },
