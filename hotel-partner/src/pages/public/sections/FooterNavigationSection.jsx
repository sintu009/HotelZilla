    ...
    <footer className="w-full bg-[#1c1c1c] px-6 pt-20 shadow-[inset_0px_4px_4px_#00000040] sm:px-12 lg:px-[8%]">
      <div className="mx-auto max-w-[1400px]">
        <header className="flex min-h-[100px] flex-col justify-between border-b-2 border-white/10 pb-12 lg:flex-row lg:items-center">
          <a href="#" className="flex items-end gap-0.5 text-[#f6f6f6] drop-shadow-[0px_4px_4px_#00000040]">
          ...
          <div className="mt-6 flex items-center justify-between gap-6 lg:mt-0">
            ...
            <button className="h-14 rounded-lg bg-[#c49c74] px-8 font-display text-lg font-medium tracking-[-0.23px] text-[#252525] hover:bg-[#c49c74]/90 lg:text-xl">Get started</button>
          </div>
        </header>
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-[minmax(0,1fr)_auto_auto_auto] lg:justify-between lg:gap-16">
          <section>
            ...
            <form className="mt-10 flex h-14 border-b-2 border-white/10" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="h-14 w-14 shrink-0 border-0 bg-[#c49c74] p-0 text-[#252525] hover:bg-[#c49c74]/90">
            ...
            <nav key={group.title}>
              ...
              <ul className="mt-5 space-y-4">
                {group.links.map((link) => (
                  <li key={link}>
                    <button className="font-display text-sm font-normal tracking-[-0.2px] text-white hover:text-white/80 lg:text-base">{link}</button>
                  </li>
                ))}
              </ul>
            </nav>
