  ...
  const handleConfirm = async () => {
    ...
    try {
      const res = await bookingsApi.create({
        ...
        guests: b.guests,
        coupon_code: b.couponCode || undefined,
        special_requests: specialRequests || undefined,
      })
      setSuccess({ booking_reference: res.id || res.booking_reference || ('BK' + Date.now().toString().slice(-8)) })
      toast.success('Booking Confirmed!', 'Your booking has been placed successfully.')
    } catch (err) {
